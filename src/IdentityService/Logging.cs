using Destructurama;
using IdentityService.ConfigurationOptions.App;
using IdentityService.ConfigurationOptions.ElasticSearch;
using IdentityService.ConfigurationOptions.Logger;
using Serilog;
using Serilog.Core;
...
public class Logging
{
    public static ILogger GetLogger(IConfiguration configuration, IWebHostEnvironment environment)
    {
        ...
        var logIndexPattern = $"Carsties.IdentityService-{environment.EnvironmentName}";
